...
CREATE TABLE `user` (
  ...
  `urgent_contact_one_country_code` int(10) unsigned NOT NULL DEFAULT '0',
  `urgent_contact_number_two` int(10) unsigned NOT NULL DEFAULT '0',
  `urgent_contact_two_country_code` int(10) unsigned NOT NULL DEFAULT '0',
  `urgent_contact_person_one` text,
  `urgent_contact_person_two` text,
  `telegram_number` varchar(64) NOT NULL DEFAULT '',
  `telegram_country_code` int(10) unsigned NOT NULL DEFAULT '0',
  `potato_number` varchar(64) NOT NULL DEFAULT '',
  `potato_country_code` int(10) unsigned NOT NULL DEFAULT '0',
