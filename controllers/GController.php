...
//                       'controllers' => ['/home/login'],
                        'actions' => ['sinch-event','home','welcome','login','login-phone','register','change-language','captcha','code','complete','find-password-one','find-password-two','find-password-three','find-password-complete',
