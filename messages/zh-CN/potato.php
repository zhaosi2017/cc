...
return [
    ...
    'is not a member of our system, can not perform the operation.' => '不是客优的用户，不能执行该操作.',
    'The number of times the call has exceeded the limit set by he.' => '呼叫超出对方设置的限制次数.',
    'The verification code is empty.' => '验证码为空',
    'Verification code error.' => '请填写验证码',
    'Open the whitelist' => '开启白名单',
    'Close the whitelist' => '关闭白名单',
    'Operation menu.' =>  '操作菜单',
    'Join Whitelist' => '加入白名单',
    'Unlock the whitelist' => '解除白名单',
    'Join blacklist' => '加入黑名单',
    'Unlock the blacklist' => '解除黑名单',
    'You are not a member of our system and can not perform this operation.' => '您不是客优用户，不能执行该操作.',
    'He is not a member of our system and you can not perform this operation.' => '他/她不是客优用户，不能执行该操作.',
