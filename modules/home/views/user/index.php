...
<div class="user-index">
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content text-center p-md" style="height: 553px;">
                    ...
                    <div class="text-left">
                        ...
                        <p class="m-t-lg" >邮箱：<?php echo $model->account; ?>  <a   class="btn btn-primary btn-sm pull-right" href="<?php echo Url::to(['/home/user/bind-email'])?>"><?php echo $model->account?'修改':'去添加';?></a>    </p>
    ...
    display: inline-block; " ><?php echo $model->un_call_number.('(总数)  ');echo $model->un_call_by_same_number.('(同一人)  ');echo $model->long_time.('  (时间)');?></span>
                         <a href="<?php echo Url::to(['/home/user/harassment']) ?>" class="btn btn-primary btn-sm pull-right"><?php echo $model->un_call_number ? '修改' : '设置'?>
