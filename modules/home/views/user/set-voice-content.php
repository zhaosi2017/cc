...
$this->title = empty($model->voice) ? Yii::t('app/user/index','Voice Content'): Yii::t('app/user/index','Voice Content');
    ...
    <?= $form->field($model, 'voice',[
        'template' => "<span class=\"text-right\">{label}</span>\n<div class=\"col-sm-3\"> {input}  </div> 
                                    <span class=\"col-sm-5 text-left\" style='margin-top: 7px'> 
                                        * ".Yii::t('app/user/index' ,'Voice Content')//."昵称为2到6个汉字
            ."</span> \n<br>
        ...
        ->label(Yii::t('app/user/index' ,'Voice Content')/*'昵称'*/ ,['class'=>'col-sm-1' , 'style'=>'margin-top: 7px;'])
    ?>
